...
public class DynamicFileImplTest {
    ...
    public void testExists() throws Exception {
        ...
        System.out.println(byteBuf1.readString(byteBuf1.readableBytesLength(), Charset.forName("UTF-8")));
        ...
        System.out.println(byteBuf.readString(byteBuf1.readableBytesLength(), Charset.forName("UTF-8")));
        FileWrapper fileWrapper = dynamicFile.getFile();
        System.out.println(fileWrapper.getVersion());
        System.out.println(fileWrapper.read().readString(byteBuf1.readableBytesLength(), Charset.forName("UTF-8")));
    }
}
...
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(5, 40);
//        buffer.writeStringUTF8("1234567890");
//        Assert.assertEquals("31323334353637383930", Hex.toHexString(buffer.array()));
//        buffer.writeStringUTF8("123456789");
//        Assert.assertEquals("3132333435363738393031323334353637383900", Hex.toHexString(buffer.array()));
//    }
//
//    @Test
//    public void testReadStringUTF8() throws Exception {
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(10, 40);
//        buffer.writeStringUTF8("1234567890");
...
//        final UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(16, 40);
//        buffer.writeInt(0x1);
//        buffer.writeInt(0x2);
...
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(Byte.MAX_VALUE, Byte.MAX_VALUE);
...
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(Short.MAX_VALUE, Short.MAX_VALUE);
...
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(1024, 1024);
...
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(2, 2);
//        buffer.writeBoolean(false);
...
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(2 * Short.MAX_VALUE, 2 * Short.MAX_VALUE);
...
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(2048, 2048);
...
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(48, 48);
...
//        UnpooledHeapByteBuffer buffer = new UnpooledHeapByteBuffer(Hex.fromHexString("30313233343536373839414243444546"), 0, 48);

...
/**
 * Exposed metric for {@link PooledByteBufferAllocator}.
 */
@SuppressWarnings("deprecation")
public final class PooledByteBufferAllocatorMetric implements ByteBufferAllocatorMetric {

    private final PooledByteBufferAllocator allocator;

    PooledByteBufferAllocatorMetric(PooledByteBufferAllocator allocator) {

...
final class UnsafeByteBufferUtil {
    ...
    static ByteBuffer copy(AbstractByteBuffer buf, long addr, int index, int length) {
        buf.checkIndex(index, length);
        ByteBuffer copy = buf.alloc().directBuffer(length, buf.maxCapacity());
        if (length != 0) {
    ...
    static int setBytes(AbstractByteBuffer buf, long addr, int index, InputStream in, int length) throws IOException {
        buf.checkIndex(index, length);
        ByteBuffer tmpBuf = buf.alloc().heapBuffer(length);
        try {
    ...
    static void getBytes(AbstractByteBuffer buf, long addr, int index, ByteBuffer dst, int dstIndex, int length) {
        buf.checkIndex(index, length);
    ...
    static void getBytes(AbstractByteBuffer buf, long addr, int index, byte[] dst, int dstIndex, int length) {
        buf.checkIndex(index, length);
        checkNotNull(dst, "dst");
    ...
    static void getBytes(AbstractByteBuffer buf, long addr, int index, java.nio.ByteBuffer dst) {
    ...
    static void setBytes(AbstractByteBuffer buf, long addr, int index, ByteBuffer src, int srcIndex, int length) {
        buf.checkIndex(index, length);
    ...
    static void setBytes(AbstractByteBuffer buf, long addr, int index, byte[] src, int srcIndex, int length) {
        buf.checkIndex(index, length);
        if (length != 0) {
    ...
    static void setBytes(AbstractByteBuffer buf, long addr, int index, java.nio.ByteBuffer src) {
    ...
    static void getBytes(AbstractByteBuffer buf, long addr, int index, OutputStream out, int length) throws IOException {
        buf.checkIndex(index, length);
        if (length != 0) {
            ByteBuffer tmpBuf = buf.alloc().heapBuffer(length);
            try {
    ...
    static UnpooledUnsafeDirectByteBuffer newUnsafeDirectByteBuf(
            ByteBufferAllocator alloc, int initialCapacity, int maxCapacity) {

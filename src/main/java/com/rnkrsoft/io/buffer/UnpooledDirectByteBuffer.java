 ...
 */
class UnpooledDirectByteBuffer extends AbstractReferenceCountedByteBuffer {
    ...
    public UnpooledDirectByteBuffer(ByteBufferAllocator alloc, int initialCapacity, int maxCapacity) {
        ...
        this.alloc = alloc;
        setByteBuffer(java.nio.ByteBuffer.allocateDirect(initialCapacity));
    }
     ...
     * @param maxCapacity the maximum capacity of the underlying direct buffer
     */
    protected UnpooledDirectByteBuffer(ByteBufferAllocator alloc, java.nio.ByteBuffer initialBuffer, int maxCapacity) {
        super(maxCapacity);
        if (alloc == null) {
            throw new NullPointerException("alloc");
        }
    ...
    private void setByteBuffer(java.nio.ByteBuffer buffer) {
    ...
    public ByteBuffer copy(int index, int length) {
        ...
        try {
            src = (java.nio.ByteBuffer) buffer.duplicate().clear().position(index).limit(index + length);

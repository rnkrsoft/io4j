 ...
 * {@link com.rnkrsoft.io.buffer.ByteBuffer}, has been designed from ground
 ...
 * <h3>Extensibility</h3>
 *
 * {@link com.rnkrsoft.io.buffer.ByteBuffer} has rich set of operations
 * optimized for rapid protocol implementation.  For example,
 * {@link com.rnkrsoft.io.buffer.ByteBuffer} provides various operations
 ...
 * {@link com.rnkrsoft.io.buffer.ByteBuffer} interface rather than
 ...
 * </pre>
 * By contrast, {@link com.rnkrsoft.io.buffer.ByteBuffer} does not have such
 ...
 * {@link ByteBuffer} message = {@link Unpooled}.wrappedBuffer(header, body);
 *
 * // Therefore, you can even create a composite by mixing a composite and an
 * // ordinary buffer.
 * {@link ByteBuffer} messageWithFooter = {@link Unpooled}.wrappedBuffer(message, footer);
 *
 * // Because the composite is still a {@link ByteBuffer}, you can access its content
 ...
 * {@link ByteBuffer} b = {@link Unpooled}.buffer(4);
 *
 ...
 * {@link com.rnkrsoft.io.buffer.ByteBuffer} is a very thin wrapper of a

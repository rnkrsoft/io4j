...
class HeapByteBuf extends ByteBuf {
    ...
    @Override
    public ByteBuf putUTF8(String... strings) {
        return put(Charset.forName("UTF-8"), strings);
    }

    @Override
    public ByteBuf putGBK(String... strings) {
        return put(Charset.forName("GBK"), strings);
    }
    ...
    @Override
    public int write(String fileName) throws IOException {

...
abstract class PooledByteBuffer<T> extends AbstractReferenceCountedByteBuffer {
    ...
    protected PooledByteBuffer(Recycler.Handle recyclerHandle, int maxCapacity) {
        super(maxCapacity);
    ...
    /**
     * Method must be called before reuse this {@link PooledByteBufferAllocator}
     */
    ...
    @Override
    public final ByteBuffer capacity(int newCapacity) {

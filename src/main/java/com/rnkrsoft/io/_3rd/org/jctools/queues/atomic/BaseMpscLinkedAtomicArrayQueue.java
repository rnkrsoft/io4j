...
public abstract class BaseMpscLinkedAtomicArrayQueue<E> extends BaseMpscLinkedAtomicArrayQueueColdProducerFields<E> implements MessagePassingQueue<E>, QueueProgressIndicators {
    ...
    public boolean offer(final E e) {
        ...
        final int offset = LinkedAtomicArrayQueueUtil.modifiedCalcElementOffset(pIndex, mask);
    ...
    public E poll() {
        ...
        final int offset = LinkedAtomicArrayQueueUtil.modifiedCalcElementOffset(index, mask);
        // LoadLoad
    ...
    private AtomicReferenceArray<E> getNextBuffer(final AtomicReferenceArray<E> buffer, final long mask) {
        ...
        final AtomicReferenceArray<E> nextBuffer = (AtomicReferenceArray<E>) LinkedAtomicArrayQueueUtil.lvElement(buffer, offset);
        LinkedAtomicArrayQueueUtil.soElement(buffer, offset, null);
        return nextBuffer;
    }
    ...
    private E newBufferPoll(AtomicReferenceArray<E> nextBuffer, long index) {
        ...
        // LoadLoad
        final E n = LinkedAtomicArrayQueueUtil.lvElement(nextBuffer, offset);
        if (n == null) {
    ...
    private int newBufferAndOffset(AtomicReferenceArray<E> nextBuffer, long index) {
        ...
        consumerMask = (LinkedAtomicArrayQueueUtil.length(nextBuffer) - 2) << 1;
        final int offsetInNew = LinkedAtomicArrayQueueUtil.modifiedCalcElementOffset(index, consumerMask);
        return offsetInNew;
    }
    ...
    public int fill(Supplier<E> s, int batchSize) {
        ...
        for (i = 0; i < claimedSlots; i++) {
            final int offset = LinkedAtomicArrayQueueUtil.modifiedCalcElementOffset(pIndex + 2 * i, mask);
    ...
    private void resize(long oldMask, AtomicReferenceArray<E> oldBuffer, long pIndex, E e) {
        ...
        final AtomicReferenceArray<E> newBuffer = LinkedAtomicArrayQueueUtil.allocate(newBufferLength);
        producerBuffer = newBuffer;
        final int newMask = (newBufferLength - 2) << 1;
        producerMask = newMask;
        final int offsetInOld = LinkedAtomicArrayQueueUtil.modifiedCalcElementOffset(pIndex, oldMask);
        final int offsetInNew = LinkedAtomicArrayQueueUtil.modifiedCalcElementOffset(pIndex, newMask);

 ...
 */
package com.rnkrsoft.io._3rd.org.jctools.maps;
...
public class NonBlockingSetInt extends AbstractSet<Integer> implements Serializable {
  ...
  static {                      // <clinit>
    ...
    _nbsi_offset = UnsafeAccess.UNSAFE.objectFieldOffset(f);
  }
  ...
  private static final class NBSI {
    ...
    private final boolean CAS( int idx, long old, long nnn ) {
      return UnsafeAccess.UNSAFE.compareAndSwapLong( _bits, rawIndex(_bits, idx), old, nnn );
    }
    ...
    static {                      // <clinit>
      ...
      _new_offset = UnsafeAccess.UNSAFE.objectFieldOffset(f);
    }
